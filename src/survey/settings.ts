...
export const INTRO_BOX = "Please read the pre-questionnaire on the Google Form and answer the questions regarding your background in sketching and using computer-aided drawing systems. Make sure you copy and paste the ID above as well. After you finish, click the Confirm button to proceed to the sketching tests in which you will sketch together with an machine agent."
